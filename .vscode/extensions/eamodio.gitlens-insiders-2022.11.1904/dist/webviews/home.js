...
`;function sr(e,t){const n=[];let r="";const i=[];for(let a=0,l=e.length-1;a<l;++a){r+=e[a];let h=t[a];if(h instanceof Un){const x=h.createBehavior();h=h.createCSS(),x&&i.push(x)}h instanceof R||h instanceof CSSStyleSheet?(r.trim()!==""&&(n.push(r),r=""),n.push(h)):r+=h}return r+=e[e.length-1],r.trim()!==""&&n.push(r),{styles:n,behaviors:i}}function Le(e,...t){const{styles:n,behaviors:r}=sr(e,t),i=R.create(n);return r.length&&i.withBehaviors(...r),i}class Ki extends null{constructor(t,n){super(),this.behaviors=n,this.css="";const r=t.reduce((i,a)=>(typeof a=="string"?this.css+=a:i.push(a),i),[]);r.length&&(this.styles=ElementStyles.create(r))}createBehavior(){return this}createCSS(){return this.css}bind(t){this.styles&&t.$fastController.addStyles(this.styles),this.behaviors.length&&t.$fastController.addBehaviors(this.behaviors)}unbind(t){this.styles&&t.$fastController.removeStyles(this.styles),this.behaviors.length&&t.$fastController.removeBehaviors(this.behaviors)}}function nc(e,...t){const{styles:n,behaviors:r}=sr(e,t);return new Ki(n,r)}const eo=":host([hidden]){display:none}";function to(e){return`${eo}:host{display:${e}}`}function no(){return!!(typeof window<"u"&&window.document&&window.document.createElement)}function ro(...e){return e.every(t=>t instanceof HTMLElement)}function rc(e,t){return!e||!t||!ro(e)?void 0:Array.from(e.querySelectorAll(t)).filter(r=>r.offsetParent!==null)}function ic(e){return e===null?null:e.which||e.keyCode||e.charCode}function io(){const e=document.querySelector('meta[property="csp-nonce"]');return e?e.getAttribute("content"):null}let Ke;function oo(){if(typeof Ke=="boolean")return Ke;if(!no())return Ke=!1,Ke;const e=document.createElement("style"),t=io();t!==null&&e.setAttribute("nonce",t),document.head.appendChild(e);try{e.sheet.insertRule("foo:focus-visible {color:inherit}",0),Ke=!0}catch{Ke=!1}finally{document.head.removeChild(e)}return Ke}let gt;function oc(){if(typeof gt=="boolean")return gt;try{gt=CSS.supports("display","grid")}catch{gt=!1}return gt}function sc(){return canUseDOM()&&(window.matchMedia("(forced-colors: none)").matches||window.matchMedia("(forced-colors: active)").matches)}function ac(){gt=void 0,Ke=void 0}const lc=null,jt=oo()?"focus-visible":"focus",so="not-allowed";function ao(e){window.addEventListener("load",()=>{new MutationObserver(()=>{ar(e)}).observe(document.body,{attributes:!0,attributeFilter:["class"]}),ar(e)})}function ar(e){const t=getComputedStyle(document.body),n=document.querySelector("body");if(n){const r=n.getAttribute("data-vscode-theme-kind");for(const[i,a]of e){let l=t.getPropertyValue(i).toString();r==="vscode-high-contrast"?(l.length===0&&a.name.includes("background")&&(l="transparent"),a.name==="button-icon-hover-background"&&(l="transparent")):a.name==="contrast-active-border"&&(l="transparent"),a.setValueFor(n,l)}}}const lr=new Map;let cr=!1;function J(e,t){const n=jn.create(e);if(t){if(t.includes("--fake-vscode-token")){const r="id"+Math.random().toString(16).slice(2);t=`${t}-${r}`}lr.set(t,n)}return cr||(ao(lr),cr=!0),n}const cc=J("background","--vscode-editor-background").withDefault("#1e1e1e"),et=J("border-width").withDefault(1),lo=J("contrast-active-border","--vscode-contrastActiveBorder").withDefault("#f38518"),uc=J("contrast-border","--vscode-contrastBorder").withDefault("#6fc3df"),fc=J("corner-radius").withDefault(0),ur=J("design-unit").withDefault(4),co=J("disabled-opacity").withDefault(.4),Wt=J("focus-border","--vscode-focusBorder").withDefault("#007fd4"),uo=J("font-family","--vscode-font-family").withDefault("-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol"),hc=J("font-weight","--vscode-font-weight").withDefault("400"),fo=J("foreground","--vscode-foreground").withDefault("#cccccc"),dc=J("input-height").withDefault("26"),pc=J("input-min-width").withDefault("100px"),ho=J("type-ramp-base-font-size","--vscode-font-size").withDefault("13px"),po=J("type-ramp-base-line-height").withDefault("normal"),gc=J("type-ramp-minus1-font-size").withDefault("11px"),bc=J("type-ramp-minus1-line-height").withDefault("16px"),yc=J("type-ramp-minus2-font-size").withDefault("9px"),vc=J("type-ramp-minus2-line-height").withDefault("16px"),mc=J("type-ramp-plus1-font-size").withDefault("16px"),wc=J("type-ramp-plus1-line-height").withDefault("24px"),xc=J("scrollbarWidth").withDefault("10px"),Sc=J("scrollbarHeight").withDefault("10px"),Rc=J("scrollbar-slider-background","--vscode-scrollbarSlider-background").withDefault("#79797966"),_c=J("scrollbar-slider-hover-background","--vscode-scrollbarSlider-hoverBackground").withDefault("#646464b3"),kc=J("scrollbar-slider-active-background","--vscode-scrollbarSlider-activeBackground").withDefault("#bfbfbf66"),Ec=J("badge-background","--vscode-badge-background").withDefault("#4d4d4d"),Pc=J("badge-foreground","--vscode-badge-foreground").withDefault("#ffffff"),go=J("button-border","--vscode-button-border").withDefault("transparent"),fr=J("button-icon-background").withDefault("transparent"),bo=J("button-icon-corner-radius").withDefault("5px"),yo=J("button-icon-outline-offset").withDefault(0),hr=J("button-icon-hover-background","--fake-vscode-token").withDefault("rgba(90, 93, 94, 0.31)"),vo=J("button-icon-padding").withDefault("3px"),bt=J("button-primary-background","--vscode-button-background").withDefault("#0e639c"),dr=J("button-primary-foreground","--vscode-button-foreground").withDefault("#ffffff"),pr=J("button-primary-hover-background","--vscode-button-hoverBackground").withDefault("#1177bb"),gn=J("button-secondary-background","--vscode-button-secondaryBackground").withDefault("#3a3d41"),mo=J("button-secondary-foreground","--vscode-button-secondaryForeground").withDefault("#ffffff"),wo=J("button-secondary-hover-background","--vscode-button-secondaryHoverBackground").withDefault("#45494e"),xo=J("button-padding-horizontal").withDefault("11px"),So=J("button-padding-vertical").withDefault("4px"),Tc=J("checkbox-background","--vscode-checkbox-background").withDefault("#3c3c3c"),Ac=J("checkbox-border","--vscode-checkbox-border").withDefault("#3c3c3c"),Fc=J("checkbox-corner-radius").withDefault(3),Lc=J("checkbox-foreground","--vscode-checkbox-foreground").withDefault("#f0f0f0"),Dc=J("list-active-selection-background","--vscode-list-activeSelectionBackground").withDefault("#094771"),Oc=J("list-active-selection-foreground","--vscode-list-activeSelectionForeground").withDefault("#ffffff"),Ic=J("list-hover-background","--vscode-list-hoverBackground").withDefault("#2a2d2e"),Bc=J("divider-background","--vscode-settings-dropdownListBorder").withDefault("#454545"),Cc=J("dropdown-background","--vscode-dropdown-background").withDefault("#3c3c3c"),$c=J("dropdown-border","--vscode-dropdown-border").withDefault("#3c3c3c"),Mc=J("dropdown-foreground","--vscode-dropdown-foreground").withDefault("#f0f0f0"),Nc=J("dropdown-list-max-height").withDefault("200px"),Uc=J("input-background","--vscode-input-background").withDefault("#3c3c3c"),Vc=J("input-foreground","--vscode-input-foreground").withDefault("#cccccc"),jc=J("input-placeholder-foreground","--vscode-input-placeholderForeground").withDefault("#cccccc"),Wc=J("link-active-foreground","--vscode-textLink-activeForeground").withDefault("#3794ff"),Hc=J("link-foreground","--vscode-textLink-foreground").withDefault("#3794ff"),zc=J("progress-background","--vscode-progressBar-background").withDefault("#0e70c0"),qc=J("panel-tab-active-border","--vscode-panelTitle-activeBorder").withDefault("#e7e7e7"),Gc=J("panel-tab-active-foreground","--vscode-panelTitle-activeForeground").withDefault("#e7e7e7"),Qc=J("panel-tab-foreground","--vscode-panelTitle-inactiveForeground").withDefault("#e7e7e799"),Yc=J("panel-view-background","--vscode-panel-background").withDefault("#1e1e1e"),Jc=J("panel-view-border","--vscode-panel-border").withDefault("#80808059"),Zc=J("tag-corner-radius").withDefault("2px"),Ro=Le`
	${to("inline-flex")} :host {
		outline: none;
		font-family: ${uo};
		font-size: ${ho};
...
`,Po=(e,t)=>Le`
	...
	${ko}
	${Eo}
`;class gr extends Ve{connectedCallback(){if(super.connectedCallback(),!this.appearance){const t=this.getAttribute("appearance");this.appearance=t}}attributeChangedCallback(t,n,r){t==="appearance"&&r==="icon"&&(this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")),t==="aria-label"&&(this.ariaLabel=r),t==="disabled"&&(this.disabled=r!==null)}}mi([q],gr.prototype,"appearance",void 0);const To=gr.compose({baseName:"button",template:Xi,styles:Po,shadowOptions:{delegatesFocus:!0}}),br=/(?<literal>\[.*?\])|(?<year>YYYY|YY)|(?<month>M{1,4})|(?<day>Do|DD?)|(?<weekday>d{2,4})|(?<hour>HH?|hh?)|(?<minute>mm?)|(?<second>ss?)|(?<fractionalSecond>SSS)|(?<dayPeriod>A|a)|(?<timeZoneName>ZZ?)/g,yr=/(?<dateStyle>full|long|medium|short)(?:\+(?<timeStyle>full|long|medium|short))?/,Ao=null;let at;const Pt=new Map;let tt,yt,nt;function Xc(e){typeof e=="string"?e==="system"?tt=void 0:tt=[e]:tt=e??void 0,yt=void 0,nt=void 0,Pt.clear(),at=void 0}function Kc(e,t){const n=new Date(e.getTime());for(const[r,i]of Object.entries(t))if(!!i)switch(r){case"years":n.setFullYear(n.getFullYear()+i);break;case"months":n.setMonth(n.getMonth()+i);break;case"days":n.setDate(n.getDate()+i);break;case"hours":n.setHours(n.getHours()+i);break;case"minutes":n.setMinutes(n.getMinutes()+i);break;case"seconds":n.setSeconds(n.getSeconds()+i);break}return n}function eu(e,t){const n=(typeof e=="number"?e:e.getTime())-new Date().getTime();for(const[r,i,a,l]of Ao){const h=Math.abs(n);if(h>=i||i===1e3)return t?(at==null&&(nt!=null?at=nt.resolvedOptions().locale:yt!=null?at=yt.resolvedOptions().locale:(nt=new Intl.RelativeTimeFormat(tt,{localeMatcher:"best fit",numeric:"always",style:"narrow"}),at=nt.resolvedOptions().locale)),at==="en"||at?.startsWith("en-")?`${Math.round(h/a)}${l}`:(nt==null&&(nt=new Intl.RelativeTimeFormat(tt,{localeMatcher:"best fit",numeric:"always",style:"narrow"})),nt.format(Math.round(n/a),r))):(yt==null&&(yt=new Intl.RelativeTimeFormat(tt,{localeMatcher:"best fit",numeric:"auto",style:"long"})),yt.format(Math.round(n/a),r))}return""}function tu(e,t,n,r=!0){t=t??void 0;const i=`${n??""}:${t}`;let a=Pt.get(i);if(a==null){const x=Lo(t);let y;n==null?y=tt:n==="system"?y=void 0:y=[n],a=new Intl.DateTimeFormat(y,x),r&&Pt.set(i,a)}if(t==null||yr.test(t))return a.format(e);function l(x){const y=`${n??""}:time:${x}`;let B=Pt.get(y);if(B==null){const K={localeMatcher:"best fit",timeStyle:x};let Q;n==null?Q=tt:n==="system"?Q=void 0:Q=[n],B=new Intl.DateTimeFormat(Q,K),r&&Pt.set(y,B)}return B}const h=a.formatToParts(e);return t.replace(br,(x,y,B,K,Q,be,ge,Ee,Lt,Zt,Sn,Gu,Qu,Yu,jr)=>{if(y!=null)return y.substring(1,y.length-1);for(const Wr in jr){const Rn=jr[Wr];if(Rn==null)continue;const Dt=h.find(Hr=>Hr.type===Wr);return Rn==="Do"&&Dt?.type==="day"?Do(Number(Dt.value)):Rn==="a"&&Dt?.type==="dayPeriod"?` ${(l("short").formatToParts(e).find(Ys=>Ys.type==="dayPeriod")??Dt)?.value??""}`:Dt?.value??""}return""})}function Fo(e,t,n){const r=(typeof t=="number"?t:t.getTime())-(typeof e=="number"?e:e.getTime());switch(n){case"days":return Math.floor(r/(1e3*60*60*24));case"hours":return Math.floor(r/(1e3*60*60));case"minutes":return Math.floor(r/(1e3*60));case"seconds":return Math.floor(r/1e3);default:return r}}function Lo(e){if(e==null)return{localeMatcher:"best fit",dateStyle:"full",timeStyle:"short"};const t=yr.exec(e);if(t?.groups!=null){const{dateStyle:r,timeStyle:i}=t.groups;return{localeMatcher:"best fit",dateStyle:r||"full",timeStyle:i||void 0}}const n={localeMatcher:"best fit"};for(const{groups:r}of e.matchAll(br))if(r!=null)for(const i in r){const a=r[i];if(a!=null)switch(i){case"year":n.year=a.length===4?"numeric":"2-digit";break;case"month":switch(a.length){case 4:n.month="long";break;case 3:n.month="short";break;case 2:n.month="2-digit";break;case 1:n.month="numeric";break}break;case"day":a==="DD"?n.day="2-digit":n.day="numeric";break;case"weekday":switch(a.length){case 4:n.weekday="long";break;case 3:n.weekday="short";break;case 2:n.weekday="narrow";break}break;case"hour":n.hour=a.length===2?"2-digit":"numeric",n.hour12=a==="hh"||a==="h";break;case"minute":n.minute=a.length===2?"2-digit":"numeric";break;case"second":n.second=a.length===2?"2-digit":"numeric";break;case"fractionalSecond":n.fractionalSecondDigits=3;break;case"dayPeriod":n.dayPeriod="narrow",n.hour12=!0,n.hourCycle="h12";break;case"timeZoneName":n.timeZoneName=a.length===2?"long":"short";break}}return n}const bn=null;function Do(e){const t=e%100;return`${e}${bn[(t-20)%10]??bn[t]??bn[0]}`}var Oo=(e=>(e.Free="free",e.FreePlus="free+",e.Pro="pro",e.Teams="teams",e.Enterprise="enterprise",e))(Oo||{}),re=(e=>(e[e.VerificationRequired=-1]="VerificationRequired",e[e.Free=0]="Free",e[e.FreeInPreviewTrial=1]="FreeInPreviewTrial",e[e.FreePreviewTrialExpired=2]="FreePreviewTrialExpired",e[e.FreePlusInTrial=3]="FreePlusInTrial",e[e.FreePlusTrialExpired=4]="FreePlusTrialExpired",e[e.Paid=5]="Paid",e))(re||{});function nu(e){const{account:t,plan:{actual:n,effective:r},previewTrial:i}=e;if(t?.verified===!1)return-1;if(n.id===r.id)switch(r.id){case"free":return i==null?0:2;case"free+":return 4;case"pro":case"teams":case"enterprise":return 5}switch(r.id){case"free":return i==null?0:1;case"free+":return 4;case"pro":return n.id==="free"?1:3;case"teams":case"enterprise":return 5}}function ru(e,t,n){return{id:e,name:Io(e),startedOn:(t??new Date).toISOString(),expiresOn:n?.toISOString()}}function Io(e){switch(e){case"free+":return"GitLens Free";case"pro":return"GitLens Pro";case"teams":return"GitLens Teams";case"enterprise":return"GitLens Enterprise";case"free":default:return"GitLens"}}const Bo=new Map([[void 0,-1],["free",0],["free+",1],["pro",2],["teams",3],["enterprise",4]]);function iu(e){return Bo.get(e)}function vr(e,t){return mr(e.plan.effective.expiresOn,t)}function mr(e,t){return e!=null?Fo(Date.now(),new Date(e),t):void 0}function ou(e){return Co(e.plan.effective.id)}function Co(e){return e!=="free"&&e!=="free+"}function su(e){const t=vr(e);return t!=null&&t<=0}function au(e){return e.plan.actual.id!==e.plan.effective.id}function lu(e){const t=mr(e.previewTrial?.expiresOn);return t!=null?t<=0:void 0}class wr{constructor(t,n=!1){this.method=t,this.overwriteable=n}}class rt extends wr{}class lt extends wr{}function Tt(e,t,n){e.method===t.method&&n(t.params,e)}const $o=new rt("webview/ready"),xr=new rt("webview/focus"),Mo=new rt("command/execute"),cu=new rt("configuration/preview"),uu=new rt("configuration/update"),fu=new lt("configuration/didChange"),hu=new lt("configuration/didPreview"),du=new lt("webview/didOpenAnchor");var No=(e=>(e.DismissedWelcome="dismissed:welcome",e.OpenedSCM="opened:scm",e))(No||{});const Uo=new rt("home/step/complete"),Vo=new rt("home/section/dismiss"),jo=new rt("home/status/dismiss"),Sr=new lt("subscription/didChange"),Rr=new lt("extensionEnabled/didChange"),_r=new lt("configuration/didChange"),kr=new lt("layout/didChange");var We;(e=>{function t(i,a,l,h){let x=!1;if(typeof i=="string"){const B=function(K){const Q=K?.target?.closest(i);Q!=null&&l(K,Q)};return document.addEventListener(a,B,h??!0),{dispose:()=>{x||(x=!0,document.removeEventListener(a,B,h??!0))}}}const y=function(B){l(B,this)};return i.addEventListener(a,y,h??!1),{dispose:()=>{x||(x=!0,i.removeEventListener(a,y,h??!1))}}}e.on=t;function n(i,a,l){const h=document.getElementById(i);if(a.replaceChildren(h?.content.cloneNode(!0)),a.className=h.className,l?.visible!=null){const x=a.querySelectorAll("[data-visible]");for(const y of x){const B=y.dataset.visible;!B||(l.visible[B]?y.style.display="initial":y.style.display="none")}}if(l?.bindings!=null){const x=a.querySelectorAll("[data-bind]");for(const y of x){const B=y.dataset.bind;if(!B)continue;const K=l.bindings[B];K!=null&&(y.textContent=String(K))}}}e.insertTemplate=n;function r(i){i.replaceChildren(),i.className=""}e.resetSlot=r})(We||(We={}));const Wo=/^(?:(#?)([0-9a-f]{3}|[0-9a-f]{6})|((?:rgb|hsl)a?)\((-?\d+%?)[,\s]+(-?\d+%?)[,\s]+(-?\d+%?)[,\s]*(-?[\d.]+%?)?\))$/i;function yn(e,t){const n=e+t,r=t<0?n<0?0:n:n>255?255:n;return Math.round(r)}function _e(e,t){return ke(e,-t)}function ke(e,t){const n=zt(e);if(n==null)return e;const[r,i,a,l]=n,h=255*t/100;return`rgba(${yn(r,h)}, ${yn(i,h)}, ${yn(a,h)}, ${l})`}function Be(e,t){const n=zt(e);if(n==null)return e;const[r,i,a,l]=n;return`rgba(${r}, ${i}, ${a}, ${l*(t/100)})`}function pu(e,t,n){const r=zt(e),i=zt(t);if(r==null||i==null)return e;const[a,l,h,x]=r,[y,B,K,Q]=i;return`rgba(${Ht(a,y,n)}, ${Ht(l,B,n)}, ${Ht(h,K,n)}, ${Ht(x,Q,n)})`}const Ht=(e,t,n)=>e+(t-e)*n/100;function zt(e){e=e.trim();const t=Wo.exec(e);if(t==null)return null;if(t[1]==="#"){const n=t[2];switch(n.length){case 3:return[parseInt(n[0]+n[0],16),parseInt(n[1]+n[1],16),parseInt(n[2]+n[2],16),1];case 6:return[parseInt(n.substring(0,2),16),parseInt(n.substring(2,4),16),parseInt(n.substring(4,6),16),1]}return null}switch(t[3]){case"rgb":return[parseInt(t[4],10),parseInt(t[5],10),parseInt(t[6],10),1];case"rgba":return[parseInt(t[4],10),parseInt(t[5],10),parseInt(t[6],10),parseFloat(t[7])];default:return null}}const Er=class{constructor(){this._disposed=!1}get event(){return this._event==null&&(this._event=(e,t,n)=>{this.listeners==null&&(this.listeners=new Tr);const r=this.listeners.push(t==null?e:[e,t]),i={dispose:()=>{i.dispose=Er._noop,this._disposed||r()}};return Array.isArray(n)&&n.push(i),i}),this._event}fire(e){if(this.listeners!=null){this._deliveryQueue==null&&(this._deliveryQueue=new Tr);for(let t=this.listeners.iterator(),n=t.next();!n.done;n=t.next())this._deliveryQueue.push([n.value,e]);for(;this._deliveryQueue.size>0;){const[t,n]=this._deliveryQueue.shift();try{typeof t=="function"?t(n):t[0].call(t[1],n)}catch{}}}}dispose(){this.listeners?.clear(),this._deliveryQueue?.clear(),this._disposed=!0}};let Pr=Er;Pr._noop=function(){};const Ho={done:!0,value:void 0},qt=class{constructor(e){this.element=e,this.next=qt.Undefined,this.prev=qt.Undefined}};let ve=qt;ve.Undefined=new qt(void 0);class Tr{constructor(){this._first=ve.Undefined,this._last=ve.Undefined,this._size=0}get size(){return this._size}isEmpty(){return this._first===ve.Undefined}clear(){this._first=ve.Undefined,this._last=ve.Undefined,this._size=0}unshift(t){return this._insert(t,!1)}push(t){return this._insert(t,!0)}_insert(t,n){const r=new ve(t);if(this._first===ve.Undefined)this._first=r,this._last=r;else if(n){const a=this._last;this._last=r,r.prev=a,a.next=r}else{const a=this._first;this._first=r,r.next=a,a.prev=r}this._size+=1;let i=!1;return()=>{i||(i=!0,this._remove(r))}}shift(){if(this._first===ve.Undefined)return;const t=this._first.element;return this._remove(this._first),t}pop(){if(this._last===ve.Undefined)return;const t=this._last.element;return this._remove(this._last),t}_remove(t){if(t.prev!==ve.Undefined&&t.next!==ve.Undefined){const n=t.prev;n.next=t.next,t.next.prev=n}else t.prev===ve.Undefined&&t.next===ve.Undefined?(this._first=ve.Undefined,this._last=ve.Undefined):t.next===ve.Undefined?(this._last=this._last.prev,this._last.next=ve.Undefined):t.prev===ve.Undefined&&(this._first=this._first.next,this._first.prev=ve.Undefined);this._size-=1}iterator(){let t,n=this._first;return{next:function(){return n===ve.Undefined?Ho:(t==null?t={done:!1,value:n.element}:t.value=n.element,n=n.next,t)}}}toArray(){const t=[];for(let n=this._first;n!==ve.Undefined;n=n.next)t.push(n.element);return t}}const Ar=new Pr,zo=Ar.event;function qo(){const e=n=>{const r=document.body,i=window.getComputedStyle(r),a=r.classList.contains("vscode-light")||r.classList.contains("vscode-high-contrast-light"),l=r.style;l.setProperty("--font-family",i.getPropertyValue("--vscode-font-family").trim()),l.setProperty("--font-size",i.getPropertyValue("--vscode-font-size").trim()),l.setProperty("--font-weight",i.getPropertyValue("--vscode-font-weight").trim()),l.setProperty("--editor-font-family",i.getPropertyValue("--vscode-editor-font-family").trim()),l.setProperty("--editor-font-size",i.getPropertyValue("--vscode-editor-font-size").trim()),l.setProperty("--editor-font-weight",i.getPropertyValue("--vscode-editor-font-weight").trim());const h=i.getPropertyValue("--vscode-editor-background").trim();let x=h;l.setProperty("--color-background",x),l.setProperty("--color-background--lighten-05",ke(x,5)),l.setProperty("--color-background--darken-05",_e(x,5)),l.setProperty("--color-background--lighten-075",ke(x,7.5)),l.setProperty("--color-background--darken-075",_e(x,7.5)),l.setProperty("--color-background--lighten-10",ke(x,10)),l.setProperty("--color-background--darken-10",_e(x,10)),l.setProperty("--color-background--lighten-15",ke(x,15)),l.setProperty("--color-background--darken-15",_e(x,15)),l.setProperty("--color-background--lighten-30",ke(x,30)),l.setProperty("--color-background--darken-30",_e(x,30)),l.setProperty("--color-background--lighten-50",ke(x,50)),l.setProperty("--color-background--darken-50",_e(x,50)),x=i.getPropertyValue("--vscode-button-background").trim(),l.setProperty("--color-button-background",x),l.setProperty("--color-button-background--darken-30",_e(x,30)),l.setProperty("--color-highlight",x),l.setProperty("--color-highlight--75",Be(x,75)),l.setProperty("--color-highlight--50",Be(x,50)),l.setProperty("--color-highlight--25",Be(x,25)),x=i.getPropertyValue("--vscode-button-secondaryBackground").trim(),l.setProperty("--color-button-secondary-background",x),l.setProperty("--color-button-secondary-background--darken-30",_e(x,30)),x=i.getPropertyValue("--vscode-button-foreground").trim(),l.setProperty("--color-button-foreground",x);let y=i.getPropertyValue("--vscode-editor-foreground").trim();y||(y=i.getPropertyValue("--vscode-foreground").trim()),l.setProperty("--color-foreground",y),l.setProperty("--color-foreground--85",Be(y,85)),l.setProperty("--color-foreground--75",Be(y,75)),l.setProperty("--color-foreground--65",Be(y,65)),l.setProperty("--color-foreground--50",Be(y,50)),x=i.getPropertyValue("--vscode-focusBorder").trim(),l.setProperty("--color-focus-border",x),x=i.getPropertyValue("--vscode-textLink-foreground").trim(),l.setProperty("--color-link-foreground",x),l.setProperty("--color-link-foreground--darken-20",_e(x,20)),l.setProperty("--color-link-foreground--lighten-20",ke(x,20)),x=i.getPropertyValue("--vscode-sideBar-background").trim(),l.setProperty("--color-view-background",x||h),x=i.getPropertyValue("--vscode-sideBar-foreground").trim(),l.setProperty("--color-view-foreground",x||y),l.setProperty("--color-view-header-foreground",i.getPropertyValue("--vscode-sideBarSectionHeader-foreground").trim()||x||y),x=i.getPropertyValue("--vscode-editorHoverWidget-background").trim(),l.setProperty("--color-hover-background",x),x=i.getPropertyValue("--vscode-editorHoverWidget-border").trim(),l.setProperty("--color-hover-border",x),x=i.getPropertyValue("--vscode-editorHoverWidget-foreground").trim(),l.setProperty("--color-hover-foreground",x),x=i.getPropertyValue("--vscode-editorHoverWidget-statusBarBackground").trim(),l.setProperty("--color-hover-statusBarBackground",x),l.setProperty("--graph-theme-opacity-factor",a?"0.5":"1"),l.setProperty("--color-graph-actionbar-background",a?_e(h,5):ke(h,5)),l.setProperty("--color-graph-actionbar-selectedBackground",a?_e(h,10):ke(h,10)),l.setProperty("--color-graph-background",a?_e(h,5):ke(h,5)),l.setProperty("--color-graph-background2",a?_e(h,10):ke(h,10)),x=i.getPropertyValue("--vscode-list-focusOutline").trim(),l.setProperty("--color-graph-contrast-border-color",x),x=i.getPropertyValue("--vscode-list-activeSelectionBackground").trim(),l.setProperty("--color-graph-selected-row",x),x=i.getPropertyValue("--vscode-list-hoverBackground").trim(),l.setProperty("--color-graph-hover-row",x),x=i.getPropertyValue("--vscode-list-activeSelectionForeground").trim(),l.setProperty("--color-graph-text-selected-row",x),l.setProperty("--color-graph-text-dimmed-selected",Be(x,50)),l.setProperty("--color-graph-text-dimmed",Be(y,20)),x=i.getPropertyValue("--vscode-list-hoverForeground").trim(),l.setProperty("--color-graph-text-hovered",x),l.setProperty("--color-graph-text-selected",y),l.setProperty("--color-graph-text-normal",Be(y,85)),l.setProperty("--color-graph-text-secondary",Be(y,65)),l.setProperty("--color-graph-text-disabled",Be(y,50)),x=i.getPropertyValue("--vscode-inputValidation-infoBackground").trim(),l.setProperty("--color-alert-infoHoverBackground",a?_e(x,5):ke(x,5)),l.setProperty("--color-alert-infoBackground",x),x=i.getPropertyValue("--vscode-inputValidation-warningBackground").trim(),l.setProperty("--color-alert-warningHoverBackground",a?_e(x,5):ke(x,5)),l.setProperty("--color-alert-warningBackground",x),x=i.getPropertyValue("--vscode-inputValidation-errorBackground").trim(),l.setProperty("--color-alert-errorHoverBackground",a?_e(x,5):ke(x,5)),l.setProperty("--color-alert-errorBackground",x),x=a?_e(h,5):ke(h,5),l.setProperty("--color-alert-neutralHoverBackground",a?_e(x,5):ke(x,5)),l.setProperty("--color-alert-neutralBackground",x),l.setProperty("--color-alert-infoBorder","var(--vscode-inputValidation-infoBorder)"),l.setProperty("--color-alert-warningBorder","var(--vscode-inputValidation-warningBorder)"),l.setProperty("--color-alert-errorBorder","var(--vscode-inputValidation-errorBorder)"),l.setProperty("--color-alert-neutralBorder","var(--vscode-input-foreground)"),l.setProperty("--color-alert-foreground","var(--vscode-input-foreground)"),n!=null&&Ar.fire()};e();const t=new MutationObserver(e);return t.observe(document.body,{attributeFilter:["class"]}),t}const Go=2**30;let Gt=0;function Fr(){return Gt===Go?Gt=1:Gt++,`webview:${Gt}`}class Qo{constructor(t){this.appName=t,this.state=window.bootstrap,window.bootstrap=void 0,this.log(`${this.appName}()`),this._api=acquireVsCodeApi(),this.onThemeUpdated!=null&&zo(this.onThemeUpdated,this),qo(),requestAnimationFrame(()=>{this.log(`${this.appName}.initializing`);try{this.onInitialize?.(),this.bind(),this.onMessageReceived!=null&&window.addEventListener("message",this.onMessageReceived.bind(this)),this.sendCommand($o,void 0),this.onInitialized?.()}finally{document.body.classList.contains("preload")&&setTimeout(()=>{document.body.classList.remove("preload")},500)}})}bind(){this.bindDisposables?.forEach(t=>t.dispose()),this.bindDisposables=this.onBind?.(),this.bindDisposables==null&&(this.bindDisposables=[]),this.bindDisposables.push(We.on(document,"focusin",t=>{const n=t.target?.tagName.includes("-")||t.target?.closest("input")!=null;(this._focused!==!0||this._inputFocused!==n)&&(this._focused=!0,this._inputFocused=n,this.sendCommand(xr,{focused:!0,inputFocused:n}))}),We.on(document,"focusout",()=>{(this._focused!==!1||this._inputFocused!==!1)&&(this._focused=!1,this._inputFocused=!1,this.sendCommand(xr,{focused:!1,inputFocused:!1}))}))}log(t,...n){}getState(){return this._api.getState()}sendCommand(t,n){const r=Fr();this.log(`${this.appName}.sendCommand(${r}): name=${t.method}`),this.postMessage({id:r,method:t.method,params:n})}async sendCommandWithCompletion(t,n,r){const i=Fr();this.log(`${this.appName}.sendCommandWithCompletion(${i}): name=${t.method}`);const a=new Promise((l,h)=>{let x;const y=[We.on(window,"message",B=>{Tt(r,B.data,K=>{B.data.completionId===i&&(y.forEach(Q=>Q.dispose()),queueMicrotask(()=>l(K)))})}),{dispose:function(){x!=null&&(clearTimeout(x),x=void 0)}}];x=setTimeout(()=>{x=void 0,y.forEach(B=>B.dispose()),h(new Error(`Timed out waiting for completion of ${r.method}`))},6e4)});return this.postMessage({id:i,method:t.method,params:n,completionId:i}),a}setState(t){this.state=t,t!=null&&this._api.setState(t)}postMessage(t){this._api.postMessage(t)}}var Yo=Object.defineProperty,Jo=Object.getOwnPropertyDescriptor,Qt=(e,t,n,r)=>{for(var i=r>1?void 0:r?Jo(t,n):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(i=(r?l(t,n,i):l(i))||i);return r&&i&&Yo(t,n,i),i};const Zo=Le`
	:host {
...
`;let At=class extends le{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}sizeChanged(){this.style.setProperty("--code-icon-size",`${this.size}px`)}};Qt([q],At.prototype,"icon",2),Qt([q],At.prototype,"modifier",2),Qt([q],At.prototype,"size",2),At=Qt([Se({name:"code-icon",styles:Zo})],At);function me(e,t){const n=typeof t=="function"?t:()=>t;return(r,i)=>e(r,i)?n(r,i):null}function Lr(...e){return e.some(t=>(t?.length??0)>0)}function gu(e){return t=>t.nodeType===e}const Xo=Le`
	:host {
		box-sizing: border-box;
	}
	:host *,
...
`;var Ko=Object.defineProperty,es=Object.getOwnPropertyDescriptor,Ze=(e,t,n,r)=>{for(var i=r>1?void 0:r?es(t,n):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(i=(r?l(t,n,i):l(i))||i);return r&&i&&Ko(t,n,i),i};const ts=fe`
	<template>
...
`;let He=class extends le{constructor(){super(...arguments),this.open=!1,this.caret=!0}get hasTopNodes(){return Lr(this.typeNodes,this.actionsNodes)}get hasHeadingNodes(){return Lr(this.headingNodes)}};Ze([q({mode:"boolean"})],He.prototype,"open",2),Ze([q({mode:"boolean"})],He.prototype,"caret",2),Ze([q],He.prototype,"placement",2),Ze([g],He.prototype,"typeNodes",2),Ze([g],He.prototype,"actionsNodes",2),Ze([g],He.prototype,"headingNodes",2),Ze([m],He.prototype,"hasTopNodes",1),Ze([m],He.prototype,"hasHeadingNodes",1),He=Ze([Se({name:"pop-over",template:ts,styles:ns})],He);const ze={toView:function(e){return e.toString()},fromView:function(e){return parseInt(e,10)}};var rs=Object.defineProperty,is=Object.getOwnPropertyDescriptor,Ft=(e,t,n,r)=>{for(var i=r>1?void 0:r?is(t,n):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(i=(r?l(t,n,i):l(i))||i);return r&&i&&rs(t,n,i),i};const os=fe`<template role="region">
...
`;let vt=class extends le{constructor(){super(...arguments),this.noHeading=!1,this.headingLevel=2,this.dismissable=!1,this.expanded=!0}handleDismiss(e){this.$emit("dismiss")}};Ft([q({attribute:"no-heading",mode:"boolean"})],vt.prototype,"noHeading",2),Ft([q({attribute:"heading-level",converter:ze})],vt.prototype,"headingLevel",2),Ft([q({mode:"boolean"})],vt.prototype,"dismissable",2),Ft([q({mode:"boolean"})],vt.prototype,"expanded",2),vt=Ft([Se({name:"card-section",template:os,styles:ss})],vt);var as=Object.defineProperty,ls=Object.getOwnPropertyDescriptor,vn=(e,t,n,r)=>{for(var i=r>1?void 0:r?ls(t,n):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(i=(r?l(t,n,i):l(i))||i);return r&&i&&as(t,n,i),i};const cs=fe`<template role="region">
